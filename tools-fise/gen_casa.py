...
H    = 1950    # reazem spate (perete 1700 + dulap 46×250 pe muchie), as-built 11.08
HF   = 1642    # reazem fata (stalpi 90×90 la 1600 + cununa 42)
...
def s1():
    ...
    sc.lead(L / 2, PL + 700, -520 + OSB, 420, -360, "inchidere: lambriu pe sipci + diagonale — vezi PLAN-pereti-lambriu")
    sc.lead(L / 2, 0, PW, 420, 420, "talpa si cununa 42×90, asezate pe LAT")
    sc.lead(1000, HF / 2, ST, -420, 300, "diagonalele panoului egale ±3 mm INAINTE de inchidere", anchor="end")
...
def s2():
    ...
    # stalpi fata 90x90 (as-built, deja montati)
    for x in (0, L):
        sc.box(x - 45, 28, -90, 90, HF, 90, "built", key=3.5e5)
    sc.tag(L / 2, 28 + H, A, "1")
    ...
    sc.lead(L / 2, 28 + 200, 0, 460, 420, "3 · FATA — la fel in colturi + 3× 6×120 in fiecare stalp 90×90")
    sc.lead(0, 28, -90, -460, 300, "stalpii fata 90×90, deja montati cu coltare in L in grinda", anchor="end")
