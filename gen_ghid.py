...
f=Fig()
f.rect(X(-120),Y(0),X(2500),X(30),fill=W2); f.text(X(-110),Y(-46),'puntea',size=13,fill=MUT,anchor='start')
...
f.text(X(1150),Y(1573),'= treapta directa pe acoperis',size=13,fill=ACC2,anchor='start')
...
f.dim(X(1660),Y(742),X(1660),Y(0),'700 dupa',vertical=True,off=-11,fill=ACC)
f.text(X(1475),Y(830),'masuta',size=13,fill=ACC)
f.text(X(1475),Y(-80),'taiat la 600–750',size=13,fill=ACC)
...
om(-900,60,'unul jos, impinge','middle')
